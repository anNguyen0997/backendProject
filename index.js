...
app.post('/register', async (req, res) => {                                              // Creates user in users table
    ...
    if(temp.hasOwnProperty('firstname') && temp.hasOwnProperty('lastname') && temp.hasOwnProperty('email') && temp.hasOwnProperty('username') && temp.hasOwnProperty('password')){
...
app.post('/stats', async (req,res) => {                                                     // Called from login.ejs
    ...
    if(temp.hasOwnProperty('username') && temp.hasOwnProperty('password')){
